...
export const ProductSimulationTabs: React.FC = () => {
  ...
  return (
    <div className="w-full">
      {/* Tab Navigation Pill Bar - Dedicated Row with pb-4 and adequate spacing */}
      <div
        role="tablist"
        aria-label="Interactive Product Capabilities"
        className="flex items-center justify-center gap-2 pb-4 mb-6 flex-wrap border-b border-[#222222]/50"
      >
        {tabs.map((tab) => {
          const Icon = tab.icon;
        ...
        <div className="p-6 md:p-8 min-h-[460px] bg-black">
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'overview' && (
              ...
              >
                {/* Left Column (col-span-7): Revenue Stat & 4 KPI Cards */}
                <div className="lg:col-span-7 flex flex-col gap-4">
                  ...
                  <div className="p-6 rounded-xl border border-[#333333] bg-[#0D0D0D]">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <div className="px-3.5 py-1.5 rounded-lg bg-[#00C076]/10 border border-[#00C076]/25 text-[#00C076] text-xs font-semibold flex items-center gap-1.5 self-start sm:self-auto">
                        <TrendingUp size={14} /> +28.4%
                      </div>
                    </div>
                  </div>

                  {/* 4 Secondary Metric Cards in 2x2 Grid */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 flex-1">
                    <div className="p-4 rounded-xl border border-[#222222] bg-[#0D0D0D] flex flex-col justify-between">
                      <div className="text-[0.6875rem] font-mono uppercase tracking-wider text-[#666666] mb-1">
                        Gross Volume
                      </div>
                      <div className="font-mono text-lg sm:text-xl font-bold text-white">₹42,85,000</div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-[#222222] bg-[#0D0D0D] flex flex-col justify-between">
                      ...
                      <div className="font-mono text-lg sm:text-xl font-bold text-white">1,420</div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-[#222222] bg-[#0D0D0D] flex flex-col justify-between">
                      ...
                      <div className="font-mono text-lg sm:text-xl font-bold text-white">₹3,017</div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl border border-[#222222] bg-[#0D0D0D] flex flex-col justify-between">
                      ...
                      <div className="font-mono text-lg sm:text-xl font-bold text-[#00C076] flex items-center gap-1.5">
                ...
                {/* Right Column (col-span-5): Live Agent Activity & Razorpay Stream */}
                <div className="lg:col-span-5 p-5 rounded-xl border border-[#333333] bg-[#0D0D0D] flex flex-col justify-between gap-4">
                  <div>
                    {/* Header */}
                    <div className="flex items-center justify-between pb-3.5 border-b border-[#222222]">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-heading text-xs font-bold text-white tracking-tight">
                          Live Agent Activity &amp; Razorpay Stream
                        </span>
                      </div>
                      <span className="font-mono text-[0.625rem] text-[#A6A6A6] bg-[#141414] px-2 py-0.5 rounded border border-[#262626]">
                        REAL-TIME
                      </span>
                    </div>
                    ...
                    <div className="mt-3.5 flex flex-col gap-2.5">
                      {/* Item 1: Transaction Authorized */}
                      <div className="p-3 rounded-lg bg-[#141414] border border-[#262626] flex flex-col gap-1.5">
                        <div className="flex items-center justify-between">
                          <span className="font-mono text-[0.6875rem] text-white font-medium">
                            order_TX6oxexSYw2Vvh
                          </span>
                          <span className="font-mono text-xs font-bold text-[#00C076]">
                            ₹1,199.00
                          </span>
                        </div>
                        <div className="text-[0.6875rem] text-[#A6A6A6] flex items-center justify-between">
                          <span>Titan Pro Magnetic Sleeve</span>
                          <span className="text-[0.625rem] font-mono text-[#666666]">14s ago</span>
                        </div>
                        <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                          <span className="px-1.5 py-0.5 rounded bg-[#00C076]/10 text-[#00C076] border border-[#00C076]/25 text-[0.625rem] font-semibold">
                            Authorized
                          </span>
                          <span className="px-1.5 py-0.5 rounded bg-[#818CF8]/10 text-[#818CF8] border border-[#818CF8]/25 text-[0.625rem] font-mono font-medium flex items-center gap-1">
                            <Lock size={9} /> HMAC Verified
                          </span>
                          <span className="px-1.5 py-0.5 rounded bg-white/5 text-[#A6A6A6] border border-white/10 text-[0.625rem] flex items-center gap-1">
                            <ShieldCheck size={9} className="text-[#00C076]" /> Pass &lt; ₹10k
                          </span>
                        </div>
                      </div>

                      {/* Item 2: Opportunity Injected */}
                      <div className="p-3 rounded-lg bg-[#141414] border border-[#262626] flex flex-col gap-1.5">
                        <div className="flex items-center justify-between">
                          <span className="font-mono text-[0.6875rem] text-white font-medium flex items-center gap-1.5">
                            <Brain size={12} className="text-[#818CF8]" /> Opp #04 Cross-Sell Bundle
                          </span>
                        ...
                        <div className="text-[0.6875rem] text-[#A6A6A6] flex items-center justify-between">
                          <span>Cart Companion Offer (10% max)</span>
                          <span className="text-[0.625rem] font-mono text-[#666666]">1m ago</span>
                        </div>
                        <div className="flex items-center gap-1.5 mt-0.5">
                          <span className="px-1.5 py-0.5 rounded bg-[#00C076]/10 text-[#00C076] border border-[#00C076]/25 text-[0.625rem] font-semibold flex items-center gap-1">
                            <CheckCircle2 size={9} /> Guardrail Cleared
                          </span>
                          <span className="text-[0.625rem] font-mono text-[#666666]">Discount: 10% &le; 15% Cap</span>
                        </div>
                      </div>

                      {/* Item 3: Policy Interceptor Gate */}
                      <div className="p-3 rounded-lg bg-[#141414] border border-[#262626] flex flex-col gap-1.5">
                        <div className="flex items-center justify-between">
                          <span className="font-mono text-[0.6875rem] text-white font-medium flex items-center gap-1.5">
                            <ShieldCheck size={12} className="text-[#00C076]" /> Policy Interceptor Gate
                          </span>
                          <span className="px-1.5 py-0.5 rounded bg-[#00C076]/15 text-[#00C076] text-[0.625rem] font-bold">
                            PASSED
                          </span>
                        </div>
                        <div className="text-[0.6875rem] text-[#A6A6A6] flex items-center justify-between">
                          <span>Ledger Entry #10,482</span>
                          <span className="text-[0.625rem] font-mono text-[#666666]">3m ago</span>
                        </div>
                        <div className="text-[0.625rem] font-mono text-[#666666] truncate">
                          sha256: 7f83b1657ff1fc53b92dc18148a1d6...
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Stream Footer Badge */}
                  <div className="pt-3 border-t border-[#222222] flex items-center justify-between text-[0.6875rem] text-[#666666] font-mono">
                    <span className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#00C076]" />
                      Razorpay Gateway: 42ms
                    </span>
                    <span className="text-[#00C076]">Zero Policy Violations</span>
                  </div>
                </div>
              </motion.div>
            )}
